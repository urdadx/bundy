...
const IntroStage = ({ handleGoogleSignIn, handlePlayAsGuest }: { handleGoogleSignIn: () => void; handlePlayAsGuest: () => void }) => (
  <div className="flex flex-col justify-center gap-4 px-1">
    ...
    <Button className="w-full" onClick={handlePlayAsGuest}>Play as Guest</Button>
  </div>
);
