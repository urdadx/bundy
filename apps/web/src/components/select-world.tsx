...
export function WorldSelector() {
  ...
  const { data: worlds, isLoading: worldsLoading, error: worldsError } = useQuery(trpc.worlds.getAll.queryOptions())
            ...
            <div key={world.id} className="relative group w-full max-w-50">
              ...
              <GameCard
                ...
                className={cn(
                  ...
                  isLocked && "opacity-80 grayscale cursor-not-allowed hover:bg-white active:translate-y-0 active:border-b-8"
                )}
              >
                <img
                  src={planetImage}
