...
interface SelectionLineProps {
  ...
  cellSize: number // e.g., 48 for size-12
  gap: number      // e.g., 8 for gap-2
}
  ...
  return (
    <div
      ...
      style={{
        top: `${startY}px`,
        left: `${startX}px`,
        width: `${distance + cellSize * 0.8}px`, // Slight padding for the pill ends
        height: `${cellSize * 0.8}px`,
        backgroundColor: "rgba(56, 189, 248, 0.3)", // sky-400/30
